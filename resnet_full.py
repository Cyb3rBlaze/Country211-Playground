...
NAME = "run_4_resnet_full_l2_0_epochs_100_lr_1e-4"
...
optimizer = torch.optim.Adam(list(feature_extractor.parameters()) + list(classification_head.parameters()), lr=lr)
...
for epoch in range(EPOCHS):
    ...
    for i, (sample, target) in tqdm(enumerate(val_loader), total=len(val_loader)-1):
        ...
        if i == len(val_loader)-1:
            ...
            # save feature extractor, and head

            torch.save(feature_extractor, "models/feature_extractor_" + NAME)
